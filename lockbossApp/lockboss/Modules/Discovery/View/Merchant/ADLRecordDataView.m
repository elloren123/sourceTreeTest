...
- (void)awakeFromNib {
    ...
    ADLTextView *briefTV = [ADLTextView textViewWithFrame:CGRectMake(0, 0, wid, 135) limitLength:200];
    ...
    ADLTextView *situationTV = [ADLTextView textViewWithFrame:CGRectMake(0, 0, wid, 135) limitLength:200];
    ...
    ADLTextView *rangeTV = [ADLTextView textViewWithFrame:CGRectMake(0, 0, wid-140, 100) limitLength:0];
